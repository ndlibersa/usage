...
switch ($action) {
	...
	case 'getAddPlatformForm':
		...
		<table class="thickboxTable" style="width:300px;padding:2px;">
		<tr><td colspan='2' id='title-sushi'><span class='headerText'>Add New Platform for SUSHI Connection</span></td></tr>
		<tr><td style='vertical-align:top;padding-top:14px;text-align:right;'><label for='platformName'><b>Platform Name: </b></label</td><td><input type='text' id='platformName' name='platformName' value="" style='width:100%;margin-top:10px;border: solid 1px #ccc;height:20px;' /><span id='span_error_Platform' style='color:red'></span></td></tr>
