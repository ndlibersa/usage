...
if ($loginID){
	...
	//most likely because the remote auth var is not working
	header('Location: not_avail.php?errorMessage=Login+is+not+working.++Check+the+.htaccess+file+and+the+remoteAuthVariableName+specified+in+/admin/configuration.ini');
}
