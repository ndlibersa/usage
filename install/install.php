		...
		if (!$link) {
			...
			if (!$dbcheck) {
				...
				if (!$row = mysql_fetch_array(mysql_query($query))){
					...
					if ($row['count'] > 0){
						$errorMessage[] = "The Usage tables already exist.  If you intend to upgrade, please run update.php instead.  If you would like to perform a fresh install you will need to manually drop all of the Usage tables in this schema first.";
					}else{
